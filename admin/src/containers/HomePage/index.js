        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <p>Ao lado você pode inserir diversos jogos, categorias e
                publishers para a nossa maravilhosa loja de jogos!{" "}</p>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <p id="app.components.HomePage.community.content"style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas ou sugestões, só ir em algum de nossos links =)</p>
               <ALink
